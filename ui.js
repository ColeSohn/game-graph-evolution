 ...
 * @file ui.js
 * @author Cole Sohn
 * @description Instructions for setting up design galleries and applying user input.
 */
 ...
 class Museum {
   ...
   createGalleries() {
     ...
     for (let i = 0; i < tot_gals; i++) {
       let curr_agents = this.agents.slice(
         i * agents_per_gal,
         (i + 1) * agents_per_gal
       );
